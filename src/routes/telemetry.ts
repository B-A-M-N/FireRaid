...
// product-build split): the host middleware and the reference adapter
// validate with the same canonical function as this route, and they cannot
// import a Worker route. Re-exported here for back-compat.
export {
